...
// ───────────────────────────────────────────────────────────────────────
// Account-setup tokens — a long random token for a CLICKED LINK
// (/account-setup?token=…) rather than a typed-in code, used only for
// ACCOUNT_SETUP VerificationCode rows (admin-created accounts). 32 random
// bytes base64url-encoded (43 chars, no padding) — leans on entropy alone
// (no attempts counter like the 8-char codes above, since a link isn't
// meant to be memorized/retyped).
// ───────────────────────────────────────────────────────────────────────
