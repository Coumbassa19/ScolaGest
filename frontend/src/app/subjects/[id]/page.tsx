...
export default async function SubjectDetailPage({ params }: { params: Promise<{ id: string }> }) {
  // Editing subject configuration stays an admin/direction action — see
  // POST/PATCH /api/subjects for why TEACHER is blocked even though
  // 'subjects' is one of their always-on core (view-only) menus.
        ...
        <div className="flex-1 px-4 py-4 md:px-8 md:py-6 overflow-y-auto">
          <AddSubjectForm
            ...
            initialData={{
              ...
              classesText: subject.classesText ?? '',
              volumeHoraire: String(subject.volumeHoraire),
              type: subject.type ?? '',
            }}
          />
        </div>
