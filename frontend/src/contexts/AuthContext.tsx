...
export interface User {
  ...
  /** Display name — editable from /profile. Null until the user sets one. */
  name: string | null;
  /** Contact phone — editable from /profile. Null until the user sets one. */
  phone: string | null;
  /** Avatar — a data URL when self-uploaded from /profile, or an OAuth-provided URL. */
  avatarUrl: string | null;
  /** App-wide role: USER | ADMIN | SUPERADMIN | DIRECTION | TEACHER. */
  role: string;
  /** Effective sidebar menu keys — null means unrestricted (ADMIN/SUPERADMIN). See Sidebar.tsx. */
  menus: string[] | null;
}
